package com.epam.task3.constant;

public class Constant {
	public static final int GLOBAL_WAIT_TIME = 300;
	...
	public static final String USERS_WRONG_CSV_FILE_PATH= "src/main/resources/userswrong.csv";
